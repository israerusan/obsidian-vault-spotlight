...
const vaultRoot = "C:\\Users\\iavil\\OneDrive\\Documents\\Personal";
...
const pluginBundle = fs.readFileSync(path.join(vaultRoot, ".obsidian", "plugins", "vault-spotlight", "main.js"), "utf8");
assert.ok(pluginBundle.includes("Vault Spotlight"), "installed bundle should contain plugin code");
assert.ok(pluginBundle.includes("vault-spotlight"), "installed bundle should reference product id");

console.log(`vault integration tests passed (${files.length} markdown files, plugin installed)`);